...
<script>
  document.title = "Pavan Kapoor — Rotary Broach";
</script>
...
# Rotary Broach
### Intermediate Manual Machining Independent Study

<img src="../Rotary broach/Finished Assembly/RB1.JPG" alt="Finished rotary broach" style="max-width:500px;">
...
<table style="border-collapse: collapse; border: none;">
  <tr>
    <td style="border: none;"><img src="../Rotary broach/broach_in_TS.JPG" alt="Rotary broach mounted in the drill chuck" width="400"/></td>
    <td style="border: none;"><img src="../Rotary broach/Pilot_hole.JPG" alt="Pilot hole with lead-in chamfer" width="400"/></td>
  </tr>
  <tr>
    <td style="border: none;"><img src="../Rotary broach/Hex_cut.JPG" alt="Broaching the hexagonal hole" width="400"/></td>
    <td style="border: none;"><img src="../Rotary broach/hex_key.JPG" alt="Allen key test-fit in the broached hex hole" width="400"/></td>
  </tr>
</table>

<img src="../Rotary broach/hex_chip.JPG" alt="Hexagonal chip cut by the broach" style="max-width:500px;">

The hexagonal chip above says it all — clean single-pass cuts, verified with an Allen key.
